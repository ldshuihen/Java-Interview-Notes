...
![](images/Fju2bguocoP9RUxvWIgcop3Nn0g.jpg)
...
![](images/SfqWbK94YoClRRxwwL0cHd9lnCb.png)
...
![](images/R8A7bYgFUo1vZLxpN76cDMySnbM.png)
...
![](images/OZsvb8liYoVxKfxozMGcHd9HnRx.png)
...
![](images/H299bUI0IoJEXvxgrGUczLq0nud.png)

需要输入账号和密码，默认都是：sentinel

登录后，即可看到控制台，默认会监控sentinel-dashboard服务本身：

![](images/BFxbbNjNfo1mdvxNtRycqkb6nPh.png)
...
![](images/RS2ubTdQJoaUFyx0jpIcE8X4nKd.png)



点击簇点链路菜单，会看到下面的页面：

![](images/IqR0bZ4AJot5csxyRpEc7FXqnud.png)
...
![](images/UE3FbWj6woljUvxAnaNcXffRnkd.png)
...
![](images/YpfebGUY8o6GCzxLbiAc9I05nAd.png)
...
![](images/IASvbbvI8o63RNxvKOCcAiB8nlg.png)

在弹出的菜单中这样填写：

![](images/VOUbbqOluonavqx3WkScy4DbnUb.png)
...
![](images/WxkAb1PsRo1fq5xy8VncoZe2n7e.png)



最终监控结果如下：

![](images/Ybj0bIzDEo3Mm5xF4xYclWh5nNc.png)
...
![](images/PUsTbAT2vojLUYxB3rIc6Vj5nEh.png)
...
![](images/C26gbIeS3om5V2xunJfcDDf1nqf.png)

在弹出的表单中填写下面内容：

![](images/KaFqbCvR0ooCW0xkDmwcVDEvnIe.png)



注意，这里勾选的是并发线程数限制，也就是说这个查询功能最多使用5个线程，而不是5QPS。如果查询商品的接口每秒处理2个请求，则5个线程的实际QPS在10左右，而超出的请求自然会被拒绝。

![](images/QQCwb4BfHoUjsHxiCPqcntxAnNc.png)



我们利用Jemeter测试，每秒发送100个请求：

![](images/KNUubRrh7omI3RxfckockKDkniu.png)

最终测试结果如下：

![](images/EWBCbrkywoJkmVxr0zoc4Dlbnfh.png)
...
![](images/QVePbxBIqoKt4IxnxHdchklPnbb.png)
...
![](images/QQEfbpcsdoNdpix59dTcHF1Xnyg.png)
...
![](images/YQeWbkS4VoDh8bxlZtzcXLfbnOb.png)



**步骤三**：在`hm-api`模块中的`ItemClient`接口中使用`ItemClientFallbackFactory`：

![](images/YYjebcfKmo9agaxTJyScONdLn1g.png)



重启后，再次测试，发现被限流的请求不再报错，走了降级逻辑：

![](images/BPjvbFaVJoA6DMx8LMecQ0BPnud.png)

但是未被限流的请求延时依然很高：

![](images/CkxybjbVAoNJRWxdXHqc7Pi0ned.png)
...
![](images/PW9IbaoktogZlCx8ophcG4V7nCk.png)

在弹出的表格中这样填写：

![](images/JVSmbTIoHobYthxf7c9cptMonMd.png)
...
![](images/SwA5b2SuEoIPFNx7w8gcVn8knNG.png)

在一开始一段时间是允许访问的，后来触发熔断后，查询商品服务的接口通过QPS直接为0，所有请求都被熔断了。而查询购物车的本身并没有受到影响。

此时整个购物车查询服务的平均RT影响不大：

![](images/AuAPbxmcJozpHOxS61Ec3h88nLe.png)
...
![](images/VP0sbKlvwoi7kwxheJJcMnW1nYc.png)

目前有4个购物车，然结算下单，进入订单结算页面：

![](images/AjOlb3UNXoFJJDxMa9scqEAsnqf.png)

然后将购物车中某个商品的库存修改为`0`：

![](images/ZJpFb31C9oJ7PFxDd4KcrBTlnnc.png)

然后，提交订单，最终因库存不足导致下单失败：

![](images/BpakbAf7eoMyv6xcgO4ciNIonTf.png)

然后我们去查看购物车列表，发现购物车数据依然被清空了，并未回滚：

![](images/SAg4bx12boM0tUxoMEhcMaNfnQg.png)
...
![](images/R528bEOPxoWwoUxOiF3c5T1Fnwf.png)
...
![](images/C7A9bYOYLokgdBxWsZxcH888n8f.png)

### 2.2.2.准备配置文件

课前资料准备了一个seata目录，其中包含了seata运行时所需要的配置文件：

![](images/AnzlbwFaFo0AtRxOT0hctMN8nab.png)

其中包含中文注释，大家可以自行阅读。

我们将整个seata文件夹拷贝到虚拟机的`/root`目录：

![](images/WryWbRfqnoK3T2xnUytcn4bCnuc.png)
...
![](images/PzbVbzEIyoQ6lixGL25cWlU7nAf.png)
...
![](images/NtFbbbIh3oM0FDxWRWacS7T7n7e.png)

结果：

![](images/ByaHbdbazoT4p1x4HZlcxkrcnWb.png)
...
![](images/FvwqbpJPSojMu0xH932c0tOanCg.png)
...
![](images/FFaJbY9ProUuvcxsCKwc0xzMnz8.png)



异常情况：

![](images/GDXpbJKpVoy3Dex0gNLceYGCnif.png)
...
![](images/VaBzb7rs0on2CcxWrOVcM6XYn3g.png)
...
![](images/CXQqbuICvoB6aZx1AR3cdKKOnNb.png)
...
![](images/Ivnhbq1MwohRbvxwJFTcsZoBnFg.png)
...
![](images/JmDAbfxKuo4VjhxcEEHczVNFnme.png)
...
![](images/MqXcbRDVfowfLXxy9chcpoRbngf.png)
